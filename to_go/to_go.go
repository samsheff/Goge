...
import (
	...
	"github.com/samsheff/goge/ast"
	"github.com/samsheff/goge/token"
)
...
func (p *printer) internalError(msg ...interface{}) {
	if debug {
		...
		fmt.Println(msg...)
		panic("github.com/samsheff/goge/to_go")
	}
}
...
func (p *printer) print(args ...interface{}) {
	for _, arg := range args {
		...
		default:
			...
			panic("github.com/samsheff/goge/to_go printer type")
		}
		// data != ""
...
unsupported:
	return fmt.Errorf("github.com/samsheff/goge/printer: unsupported node type %T", node)
}
